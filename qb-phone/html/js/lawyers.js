SetupLawyers = function(data) {
    ...
    if (data.length > 0) {
        ...
        if (taxi.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Der er ingen ledige taxer.</div></div>'
            $(".lawyers-list").append(element);
        }
        ...
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(255, 0, 0);">Læge (' + ambulance.length + ')</h1>');
                ...
                if (status.CanCall) {
                    if (!status.InCall) {
                        if (QB.Phone.Data.AnonymousCall) {
                            QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Du startede et opkald med hemmeligt nummer!");
                        }
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Du er i gang med et opkald!");
                    }
                } else {
                    QB.Phone.Notifications.Add("fas fa-phone", "Phone", "Nummeret er optaget");
                }
            } else {
